...
- [规范与开发流程](<01_Frameworks_&_Flows/README.md>)
...
- [MCU软件开发流程](<01_Frameworks_&_Flows/MCU软件开发流程.md>)
- [BMS软件开发流程_详细版](<01_Frameworks_&_Flows/BMS软件开发流程_详细版.md>)
- [ROS软件开发流程_详细版](<01_Frameworks_&_Flows/ROS软件开发流程_详细版.md>)
- [嵌入式硬件课程大纲](<02_Hardware_Engineering/嵌入式硬件课程大纲.md>)
- [嵌入式软件课程大纲](<03_Software_Architecture/嵌入式软件课程大纲.md>)

## 目录角色

- `00_Curriculum_&_Growth`: 技能树、成长路线、简历与阶段性规划。
